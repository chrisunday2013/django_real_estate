...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('profiles', '0004_alter_profile_license'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='profile',
            name='phone_number',
            field=phonenumber_field.modelfields.PhoneNumberField(default='+23470356789', max_length=30, region=None, verbose_name='Phone Number'),
        ),
        migrations.AlterField(
            model_name='profile',
            name='rating',
