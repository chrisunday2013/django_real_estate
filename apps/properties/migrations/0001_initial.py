    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postal_code', models.CharField(default='140', max_length=100, verbose_name='PostalCode')),
                ('street_address', models.CharField(default='KGB Avenue', max_length=150, verbose_name='Street Address')),
                ...
                ('tax', models.DecimalField(decimal_places=2, default=0.15, help_text='15% property tax charged', max_digits=8, verbose_name='Property Tax')),
